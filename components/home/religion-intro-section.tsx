      ...
      <div className="container mx-auto max-w-6xl space-y-32">
        ...
        >
          ...
          <div className="md:col-span-7 text-justify text-zinc-300 text-base md:text-lg leading-relaxed pt-2">
            <p>
              <strong className="text-white">Tín ngưỡng thờ Mẫu</strong> là hệ thành tâm linh bản địa lâu đời của người Việt. Khác với nhiều tôn giáo hướng tới thế giới sau cái chết, thờ Mẫu tập trung hoàn toàn vào cuộc sống hiện sinh—cầu mong sức khỏe, tài lộc và may mắn ngay tại trần gian qua hình tượng người Mẹ vĩ đại.
            </p>
          </div>
        </motion.div>

        {/* ĐOẠN 2: CỐT LÕI (Split-screen layout: Left 2x2 Image Grid | Right Text Block) */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        ...
        >
          {/* BÊN TRÁI: Grid 2x2 gồm 4 Section đè chữ lên hình */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:col-span-7 order-2 lg:order-1">
            {[
              { name: "Mẫu Thượng Thiên", domain: "Miền Trời", img: "/mau-thien-tien.png" },
              { name: "Mẫu Địa", domain: "Miền Đất", img: "/mau-dia-tien.png" },
              { name: "Mẫu Thoải", domain: "Miền Nước", img: "/mau-thuy-tien.png" },
              { name: "Mẫu Thượng Ngàn", domain: "Miền Rừng Núi", img: "/mau-nhac-tien.png" },
            ].map((mother, idx) => (
              <div 
                key={idx} 
              ...
              >
                ...
                />
                {/* Lớp phủ mờ gradient làm nổi bật chữ */}
                ...
                {/* Chữ hiển thị đè lên góc dưới của hình */}
          ...
          {/* BÊN PHẢI: Tiêu đề và Nội dung khái quát xếp dọc */}
          <div className="flex flex-col items-start lg:col-span-5 order-1 lg:order-2 space-y-4">
            ...
            <p className="text-justify text-zinc-300 text-base md:text-lg leading-relaxed pt-2">
              Cốt lõi đức tin nằm ở hệ thống <strong className="text-white">Tam Phủ, Tứ Phủ</strong> đại diện cho bốn miền không gian của vũ trụ: <strong className="text-white">Mẫu Thượng Thiên</strong>, <strong className="text-white">Mẫu Địa</strong>, <strong className="text-white">Mẫu Thoải</strong>, và <strong className="text-white">Mẫu Thượng Ngàn</strong>. Sự tôn kính này thể hiện triết lý sống hòa hợp và tôn trọng thiên nhiên sâu sắc.
            </p>
          </div>
        </motion.div>
        ...
        <div className="relative w-full overflow-hidden rounded-3xl border border-zinc-900 bg-zinc-950">
          ...
          >
            ...
            <div className="md:col-span-7 text-justify text-zinc-300 text-base md:text-lg leading-relaxed pt-2 space-y-6">
              <p>
                Hệ thống thần linh của Tứ Phủ chính là sự "lịch sử hóa" các vị anh hùng, nghĩa sĩ ngoài đời thật có công đánh đuổi giặc ngoại xâm hay khai phá đất đai, dạy dân trồng lúa. Thờ phụng họ là cách người Việt gìn giữ đạo lý vẹn nguyên qua ngàn năm: <strong className="text-white">"Uống nước nhớ nguồn"</strong>.
              </p>
            </div>
          </motion.div>
        </div>
